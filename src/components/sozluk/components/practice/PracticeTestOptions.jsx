    ...
    const uniqueLanguages = React.useMemo(() => {
        ...
        (words || []).forEach(w => {
            if (w.language) {
                ...
                langs.add('İngilizce'); // Fallback for old data
            }
        });
        const arr = Array.from(langs);
        if (arr.length === 0) arr.push('İngilizce');
        return arr.sort();
    }, [words]);
            ...
            <div className="text-body-secondary w-100">
                ...
                <div className="mb-4 pb-3 border-bottom border-secondary border-opacity-25">
                    ...
                    <div className="d-flex flex-nowrap overflow-x-auto gap-3 pb-2 custom-scrollbar" style={{ scrollbarWidth: 'thin', WebkitOverflowScrolling: 'touch' }}>
                        {(() => {
                            const slots = customQuickTests.map(test => ({ type: 'custom', data: test }));
                                                    ...
                                                    {(() => {
                                                        ...
                                                        return (
                                                            <div className="d-flex flex-column text-body-secondary mt-2" style={{ fontSize: '11px', opacity: 0.85, gap: '4px' }}>
                                                                ...
                                                                {(() => {
                                                                    const adv = test.config.advancedOptions || {};
                                                                    const activeModes = [];
                                                                    if (adv.fillInTheBlanks) activeModes.push('Boşluk Doldurma');
                                                                    if (adv.smartDistractors) activeModes.push('Akıllı Şıklar');
                                                                    if (adv.missingLetters) activeModes.push('Eksik Harfler');
                                                                    if (adv.singleMeaning) activeModes.push('Tek Anlam');
                                                                    if (adv.comboStreak) activeModes.push('Kombo Sistemi');
                                                                    if (adv.matchPairs) activeModes.push('Eşleştirme');
                                                                    if (adv.progressiveHint) activeModes.push('Kademeli İpucu');
                                                                    if (adv.timeSurvival) activeModes.push('Zamana Karşı');
                                                                    
                                                                    if (activeModes.length > 0) {
                                                                        return (
                                                                            <div className="mt-1 pt-1 border-top border-secondary border-opacity-25">
                                                                                <div className="d-flex align-items-center gap-2 text-primary opacity-75">
                                                                                    <i className="bi bi-puzzle-fill" style={{ fontSize: '11px', width: '12px' }}></i>
                                                                                    <span className="text-truncate" style={{ fontSize: '10px', fontWeight: '600' }} title={activeModes.join(', ')}>
                                                                                        {activeModes.join(', ')}
                                                                                    </span>
                                                                                </div>
                                                                            </div>
                        ...
                        <div className="d-flex gap-2 pb-2" style={{ overflowX: 'auto', scrollbarWidth: 'thin', whiteSpace: 'nowrap' }}>
                            ...
                            {(!practiceTests || practiceTests.length === 0) && (
                                <div className="text-muted small py-2 fst-italic">
                                    Henüz tamamlanmış veya devam eden bir testiniz bulunmuyor. Testi başlattıktan sonra burada listelenecektir.
                                </div>
                            )}
                        </div>
                    </div>
                ...
                <Row className="g-4">
                    ...
                    <Col lg={4} className="d-flex flex-column gap-4">
                        <div className="border-0 shadow-sm rounded-4 p-4 bg-light d-flex flex-column gap-4 h-100">
                            <div>
                                <h6 className="text-body fw-bold mb-3 d-flex align-items-center gap-2">
                ...
                <div className="border-0 shadow-sm rounded-4 p-4 bg-light mt-4 mb-4">
                    ...
                    <Row className="g-3">
                        ...
                        <Col md={12} lg={8}>
                            <div className={`p-3 border rounded-4 transition-all h-100 ${advancedOptions.fillInTheBlanks ? 'border-primary bg-primary bg-opacity-10' : 'border-secondary border-opacity-25 bg-light'}`}>
                        ...
                        {/* 2. Çeldirici Şıklar */}
                        <Col md={6} lg={4}>
                            <div className={`d-flex justify-content-between align-items-start text-body p-3 border rounded-4 transition-all h-100 ${advancedOptions.smartDistractors ? 'border-primary bg-primary bg-opacity-10' : 'border-secondary border-opacity-25 bg-light'}`}>
                                <div>
                        ...
                        <Col md={6} lg={4}>
                            <div className={`d-flex justify-content-between align-items-start text-body p-3 border rounded-4 transition-all h-100 ${advancedOptions.missingLetters ? 'border-primary bg-primary bg-opacity-10' : 'border-secondary border-opacity-25 bg-light'}`}>
                                <div>
                        ...
                        <Col md={6} lg={4}>
                            <div className={`d-flex justify-content-between align-items-start text-body p-3 border rounded-4 transition-all h-100 ${advancedOptions.singleMeaning ? 'border-primary bg-primary bg-opacity-10' : 'border-secondary border-opacity-25 bg-light'}`}>
                                <div>
                        ...
                        <Col md={6} lg={4}>
                            <div className={`d-flex justify-content-between align-items-start text-body p-3 border rounded-4 transition-all h-100 ${advancedOptions.comboStreak ? 'border-primary bg-primary bg-opacity-10' : 'border-secondary border-opacity-25 bg-light'}`}>
                                <div>
                        ...
                        <Col md={6} lg={4}>
                            <div className={`d-flex justify-content-between align-items-start text-body p-3 border rounded-4 transition-all h-100 ${advancedOptions.matchPairs ? 'border-primary bg-primary bg-opacity-10' : 'border-secondary border-opacity-25 bg-light'}`}>
                                <div>
                        ...
                        {/* 7. Kademeli İpucu */}
                        <Col md={6} lg={4}>
                            <div className={`d-flex justify-content-between align-items-start text-body p-3 border rounded-4 transition-all h-100 ${advancedOptions.progressiveHint ? 'border-primary bg-primary bg-opacity-10' : 'border-secondary border-opacity-25 bg-light'}`}>
                                <div>
                                    <div className="fw-bold d-flex align-items-center gap-2 text-warning">
                        ...
                        <Col md={6} lg={4}>
                            <div className={`d-flex justify-content-between align-items-start text-body p-3 border rounded-4 transition-all h-100 ${advancedOptions.timeSurvival ? 'border-primary bg-primary bg-opacity-10' : 'border-secondary border-opacity-25 bg-light'}`}>
                                <div>
                                    <div className="fw-bold d-flex align-items-center gap-2 text-danger">
