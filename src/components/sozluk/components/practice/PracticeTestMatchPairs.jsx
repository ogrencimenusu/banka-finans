                     ...
                     <div className="d-flex flex-wrap gap-3 justify-content-center p-md-4">
                         {cards.map(card => {
                             ...
                             if (isMatched) {
                                 ...
                                 containerClass += "bg-light border border-primary border-opacity-25 text-body match-card-hover ";
                             } else {
                                 containerClass += "bg-light border border-secondary border-opacity-25 text-body match-card-hover ";
                             }
