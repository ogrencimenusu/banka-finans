...
function WordDetailModal({ 
    ...
    */
    ...
    const wordNotes = stickyNotes.filter(n => 
        n.wordId === word?.id || 
        (n.wordTerm && n.wordTerm.toLowerCase() === word?.term?.toLowerCase()) ||
    ...
    const handleCopyNote = useCallback((note, isAssociated) => {
        ...
        const showSuccessToast = () => {
            alert('Not metni ve kelime kopyalandı!');
        };
            ...
            >
                ...
                <Modal.Body className="p-4 p-md-5 custom-scroll" ref={modalBodyRef}>
                    ...
                    <div className="sticky-notes-section mb-4">
                        ...
                        {isAddingNote && (
                            <div className="card border-0 shadow-sm rounded-4 p-4 mb-4 transition-all border border-primary border-opacity-25">
                              <div className="d-flex align-items-start gap-3">
                                <div className="flex-shrink-0 d-flex align-items-center justify-content-center bg-primary bg-opacity-10 text-primary rounded-circle" style={{ width: '40px', height: '40px' }}>
                            ...
                            <div className="d-flex flex-column gap-3 mb-4">
                                {wordNotes.map((note) => {
                                    ...
                                    return (
                                        <div 
                                            key={note.id} 
                                            className={`card border-0 shadow-sm rounded-4 p-4 mb-3 transition-all ${isEditing ? 'border border-primary border-opacity-25' : ''}`}
                                        >
                                          <div className="d-flex align-items-start gap-3">
                                            <div className="flex-shrink-0 d-flex align-items-center justify-content-center bg-primary bg-opacity-10 text-primary rounded-circle" style={{ width: '40px', height: '40px' }}>
                                              <i className={`bi bi-pin-angle-fill fs-5`}></i>
                                            ...
                                            {isEditing ? (
                                                ...
                                                <>
                                                    {note.title && <div className="fw-bold text-primary mb-2 fs-6">{note.title}</div>}
                                                    <div 
                                                        className="mb-2" 
                                                        style={{ 
                                                            fontSize: '1rem', 
